 ...
 * @author:     Larry.Li  
 * @version:    v1.0.0
 * Create Date: 2014年1月23日 下午7:40:10
 */
...
public class RepositoryHelper<T extends AbstractEntity<ID>, ID extends Serializable> implements EntityManagerHelper<T, ID> {
	...
	public static EntityManager getEntityManager() {
		Assert.notNull(entityManager, "entityManager must null, please see [com.aicent.fw.common.repository.RepositoryHelper#setEntityManagerFactory]");
